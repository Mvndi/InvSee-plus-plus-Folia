...
# this file is from https://github.com/PimvanderLoos/BigDoors/blob/1e9906af31f5c8b7853e95a8aba317326258d6f8/setupEnv.sh
...
VERSIONS=(     1.8.8  1.12.2  1.16.5 1.17.1  1.18.2  1.19.4  1.20.1  1.20.2  1.20.4  1.20.6  4287     1.21.1 1.21.3  1.21.4  1.21.5  1.21.6  1.21.7 )
JAVA_VERSIONS=("$J_8" "$J_8" "$J_8" "$J_17"  "$J_17" "$J_17" "$J_17" "$J_17" "$J_17" "$J_21" "$J_21" "$J_21" "$J_21" "$J_21" "$J_21" "$J_21" "$J_21")
